  ...
  return (
    <div className="flex md:flex-row gap-5 flex-col bg-black text-white px-7 md:px-10 py-10">
      <div className="flex-1 ">
        ...
        <Link href="https://github.com/AAlchi/portfolio" target="_blank" className="pt-2 flex items-center gap-2 cursor-pointer font-sm">View Website GitHub Repository <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{ width: "20px" }}>

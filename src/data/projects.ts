  ...
  projects: [
    {
      ...
      description:
        "Social media site created with Next Typescript for a global organization called Hack Club. Built for school Hack Club as the social media platforom to communicate with each other and upload announcements and reminders.",
      ...
      },
    {
      ...
      description:
        "If you are interested in my services, please contact me. I have created many more projects.",
      languages: []
    },
  ],
};

...
export const ContactTwo = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div></div>
        <a style={{fontSize: "20px", display: "flex", alignItems: "center", gap: "10px", cursor: "pointer"}} onClick={() => navigate("/resume")}>View Resume <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style={{width: "20px"}}>

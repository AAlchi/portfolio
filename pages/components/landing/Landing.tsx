    ...
    <div className={`h-screen`}>
      ...
      <motion.div
        ...
        <div className="flex flex-wrap text-center justify-center gap-3 lg:gap-5 md:gap-5 text-lg md:text-xl lg:text-xl">
          <Link target="_blank" className="flex items-center gap-2 cursor-pointer" style={{ textShadow: "1px 1px 1px white, 0 0 1em white, 0 0 0.1em black" }} href="https://github.com/AAlchi">View GitHub Repo <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{ width: "20px" }}>
          ...
          <Link target="_blank" className="flex items-center gap-2 cursor-pointer" style={{ textShadow: "1px 1px 1px white, 0 0 1em white, 0 0 0.1em black"}} href="/resume">View Resume <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{ width: "20px" }}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
          </Link>
        </div>
      </motion.div>
